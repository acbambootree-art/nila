...
export default function Collection() {
  return (
    <section id="collection" className="relative py-24 lg:py-32 bg-navy/30">
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12">
        {/* Section header */}
        <div className="text-center mb-14 animate-on-scroll">
          <p className="text-gold/50 text-xs tracking-[0.3em] uppercase mb-3 font-light">The Collection</p>
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {products.map((product, i) => (
            ...
            >
              <div className="relative h-full bg-black-deep/60 border border-white/[0.06] hover:border-gold/20 transition-all duration-500 overflow-hidden">
                {/* Product image */}
                <div className="overflow-hidden">
                  <img
                    src={product.image}
                    alt={product.name}
                    className="w-full h-[280px] object-cover object-center group-hover:scale-[1.03] transition-transform duration-700"
                  />
                </div>

                <div className="p-7 lg:p-8">
                  <p className="text-gold/40 text-[10px] tracking-[0.25em] uppercase mb-2 font-light">
                    {product.type}
                  </p>
                  ...
                  <div className="gold-line w-10 opacity-30 my-5" />
                  ...
                  <div className="mt-6 pt-5 border-t border-white/[0.06] flex items-center justify-between">
                    ...
                    <span className="text-gold/25 text-[10px] tracking-[0.15em] uppercase group-hover:text-gold/50 transition-colors duration-500">
                      Enquire &rarr;
                    </span>
                  </div>
                </div>
        ...
        <p className="text-center mt-10 text-white/20 text-xs font-light italic animate-on-scroll">
