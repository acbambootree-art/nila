    ...
    <section id="story" className="relative py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-14 animate-on-scroll">
          <p className="text-gold/60 text-xs tracking-[0.3em] uppercase mb-3 font-light">Our Heritage</p>
        ...
        {/* Two images — stack on mobile with taller heights */}
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
          <div className="space-y-5 animate-on-scroll">
            <p className="text-white/70 leading-[1.85] font-light text-[15px]">
            ...
            <div className="pt-4 flex items-start gap-8 md:gap-10">
              {[
                ...
                <div key={stat.unit}>
                  ...
                  <p className="text-white/40 text-[10px] tracking-[0.2em] uppercase mt-1">{stat.unit}</p>
                </div>
              ))}
            </div>
          </div>
